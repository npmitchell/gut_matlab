...
datdir = '/mnt/data/confocal_data/gut/Mef2GAL4klarUASGCAMP6sIII/AnteriorFold/analysis_mef2G4kGCaMP6sIII/' ;
expts = {'202106261342_e1_anteriorDorsal',...
    '202106261342_e2_anteriorDorsal',...
    '202106261342_e3_anteriorDorsal',...
    '202106271653_e1_anteriorDorsal',...
    '202106271653_e2_anteriorDorsal',...
    '202106271653_e3_anteriorDorsal',...
    } ;
...
pix2um = [0.2431478097622, 0.2431478097622, 2431478097622, ...     % 202106261342
    0.241965707, 0.241965707, 0.241965707,] ;    % 202106271653
...
foldXs = [304,225,328, ...       % 202106261342 e1, e2, e3
    ,,] ;          % 202106271653 e1, e2, e3
% fold frame # at which position is measured
foldTs = [64,30,53, ...         % 202106261342 e1, e2, e3
    ,,] ;               % 202106271653 e1, e2, e3
% onset of anterior folding in minutes
t0 = 1.5 * [41,30,53, ...         % 202106261342 e1, e2, e3
    ,,] ;               % 202106271653 e1, e2, e3
