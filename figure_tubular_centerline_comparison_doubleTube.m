...
close all
clc
dataDir = '/mnt/data/tubular_test/tube_centerlines/doubleTube2/' ;
...
try
    ...
    RR = 0.8 ; % radius of coil
    R1 = 0.2 ; % amount of radial undulation / variation along pathlength
    R2 = 0.1 ;
    debug = false ;
    ...
    ww = 0.7 + R1 * cos(zz*pi/LL) ;
    w2 = 0.7 + R2 * cos(zz*pi/LL) ;
    % points in 3D of the coil
    rr = [ 0*zz; RR * sin(zz*pi/LL) ; zz]' ;
    r2 = [ 0*zz; -RR * sin(zz*pi/LL); zz]' ;
