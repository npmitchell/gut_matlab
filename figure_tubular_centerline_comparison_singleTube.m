...
%%
outdir = '/mnt/data/tubular_test/tube_centerlines/single_coil/' ;
if ~exist(outdir, 'dir')
    mkdir(outdir) ;
end
...
try
    ...
    plywrite(fullfile(outdir, 'msls_output', 'mesh_ls_000000.ply'), mesh.f, mesh.v) 
    plywrite_with_normals(fullfile(outdir, 'msls_output', 'mesh_000000.ply'), mesh_sm.f, mesh_sm.v, mesh_sm.vn) 
...
if ~exist(tubi.fileName.endcapOptions, 'file') || overwrite
    endcapOpts = struct( 'adist_thres', 5, ...  % 20, distance threshold for cutting off anterior in pix
