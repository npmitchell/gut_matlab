...
error('DO NOT USE THIS VERSION -- USE THE LAGRANGIAN ONE')
% %% PATHLINE COORDS
% t0Pathline = 1; 
% sresStr = '' ;
% nU = tubi.nU ;
...
sresStr = '' ;
nU = tubi.nU ;
outdir = './TubULAR_Paper_Figures/Kymographs_SPhiCoordSys/' ;
...
plotTypes = {'divv', 'H2vn', 'veln', 'HH', 'radius'} ;
...
for ii = 1:length(plotTypes)
    ...
    saveas(gcf, fullfile(outdir, [ plotType '_sphi.pdf']))
end
