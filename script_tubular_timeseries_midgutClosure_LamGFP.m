...
cd /mnt/crunch/48YGAL4klarLamGFPCAAXmCh/202308122137_180s_1p4um_2mW2mW_48YG4kLamGFPCAAXmCh_4views_0p25_0p5ms/dataLamGFP_resavedViaMATLAB/
zwidth =1 ;
...
if ~exist('./masterSettings.mat', 'file')  || true
    ...
    timePoints = 0:101;       % timepoints to include in the analysis
    ...
    scale = [0.4 0.2] ;      % scale for conversion to 16 bit, one value for each channel
...
dir32bit = fullfile(dataDir, 'deconvolved_20iter') ;
