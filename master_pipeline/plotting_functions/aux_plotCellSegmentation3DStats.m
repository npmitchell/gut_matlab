...
imfn = fullfile(QS.dir.segmentation, segSubDir, 'cell_meanQAaspectRatio') ;
...
imfn = fullfile(QS.dir.segmentation, segSubDir, 'cell_meanQEaspectRatio') ;
...
%% Plot meanQ_E AR +/- unc, meanQ Theta +/- unc over time
imfn = fullfile(QS.dir.segmentation, segSubDir, 'cell_meanQEeccentricity') ;
...
imfn = fullfile(QS.dir.segmentation, segSubDir, 'cell_anisotropyRaw') ;
timestamps = timePoints - t0 ;
if contains(lower(QS.timeUnits), 'min')
    timestamps = timestamps / 60 ;
    timeunits = 'hr' ;
