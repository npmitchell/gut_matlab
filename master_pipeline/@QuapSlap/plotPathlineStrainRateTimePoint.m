...
if isempty(mesh) 
    ...
    % FLOWS
    fn2 = fullfile(egImDir, 'strainRate2d', ...
        sprintf([QS.fileBase.spcutMeshSm '.png'], tp));
    fnS = fullfile(egImDir, 'strain2d', ...
        sprintf([QS.fileBase.spcutMeshSmRSC '.png'], tp));

    redo_images = ~exist(fn2, 'file') || ...
                  ~exist(fnS, 'file') || overwrite ;
...
close all
set(gcf, 'visible', 'off') ;
fn = fullfile(egImDir, 'strainRate2d_compareDEC', ...
