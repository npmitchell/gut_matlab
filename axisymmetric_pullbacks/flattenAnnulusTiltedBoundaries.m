function newCutMesh = flattenAnnulusTiltedBoundaries( cutMesh, phi0, phi1, LType)
%FLATTENANNULUS This function homotopically flattens a 3D topological
%annulus by embedding it within a 2D annular Euclidean orbifold, mapping 
%to a domain with offset left and right vertical boundaries, offset by phi0
%and phi1, respectively. Never actually used in QuapSlap, but written for
%uv' coordinate system (now derived from spcutMeshes instead).
% TODO: Trash this file and allow offsets in flattenAnnulus()
% 
%   INPUT PARAMETERS:
...
%
%   SEE ALSO:
%   flattenAnnulus() -- maps to a unit square domain
% 
% by Dillon Cislo & NPMitchell 2020
...
v1 = [0,phi0 + 1]; % The start coordinates of the target line
v2 = [0,phi0 + 0]; % The final coordinates of the target line
...
v1 = [1,phi1 + 0]; % The start coordinates of the target line
v2 = [1,phi1 + 1]; % The final coordinates of the target line
