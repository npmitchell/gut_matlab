...
for iprev = 1:ii-1
    ...
    if tidx == 1
        ...
        plot(trackprev(1:tidx, 1)-minX, trackprev(1:tidx, 2)-minY, '-', 'color', bluecolor, 'lineWidth', 1)
    end
end
hold off;
...
for iprev = 1:ii-1
    trackprev = currentTracks{iprev} ;
    if tidx == 1
        plot(trackprev(1:tidx, 1)-minX, trackprev(1:tidx, 2)-minY, 's', 'color', bluecolor, 'markerSize', markerSize, 'lineWidth', 1)
    else
        plot(trackprev(1:tidx, 1)-minX, trackprev(1:tidx, 2)-minY, '-', 'color', bluecolor, 'markerSize', markerSize, 'lineWidth', 1)
    end
end
hold off;
title(['merge' exten1])
