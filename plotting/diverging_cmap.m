...
% -------------
% % Blue to red:
% cmap1 = diverging_cmap([0:0.01:1], 1, 2)
% % Black to white:
...
rgb_1 = [0.230, 0.299, 0.754] ;
rgb_2 = [0.706, 0.016, 0.150] ;
rgb_3 = [0.436, 0.308, 0.631] ;
rgb_4 = [0.759, 0.334, 0.046] ;
rgb_5 = [0.217, 0.525, 0.910] ;
rgb_6 = [0.217, 0.525, 0.910] ;
rgbs = [rgb_1; rgb_2; rgb_3; rgb_4; rgb_5; rgb_6] ;
if all(size(rgb1) == 1)
    rgb1 = rgbs(rgb1, :) ;
end
if all(size(rgb2) == 1)
