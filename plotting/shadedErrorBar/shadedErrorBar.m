...
params.addParameter('makeEdge', false, @(x) islogical(x) || x==0 || x==1)
...
makeEdge = params.Results.makeEdge ;
...
H = makePlot(x,y,errBar,lineProps,transparent,patchSaturation,makeEdge);
...
function H = makePlot(x,y,errBar,lineProps,transparent,patchSaturation,makeEdge)
